...
export class ChatPrivado {
  ...
  @OneToOne(() => SolicitudAmistad, (solicitud) => solicitud.chatPrivado, {
    onDelete: 'CASCADE',
  })
  @JoinColumn()
...
export class Grupos {
  ...
  @OneToMany(() => InvitacionesGrupos, (invitacion) => invitacion.grupo, {
    cascade: true,
  })
...
export class Comunidades {
  ...
  @OneToMany(() => MiembrosComunidades, (miembro) => miembro.comunidad, {
    cascade: true,
  })
